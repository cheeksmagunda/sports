...
last_verified: 2026-05-27T01:30:00Z
...
- postgres: internal, migrations applied (alembic head = 20260527_0002)
- redis:    internal, password-protected
- cron-job1: cron `0 13 * * *` UTC, oracle-cron --job job1
- cron-job2: cron `*/15 21-23,0-3 * * *` UTC, oracle-cron --job job2
...
Test suite: 43 unit tests, all passing. ruff + mypy strict on src/ clean.
