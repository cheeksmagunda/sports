...
CONNECTORS: Final[tuple[ConnectorSpec, ...]] = (
    ...
    ConnectorSpec(
        ...
        configuration_env_vars=(),
        roles=("job2",),
        failure_semantics="job2_coordination_failure_fails_closed;serving_uses_postgres",
    ),
    ConnectorSpec(
    ...
    ConnectorSpec(
        ...
        configuration_env_vars=(
            ...
            "WNBA_RAILWAY_BACKFILL_SERVICE_ID",
        ),
        roles=(
            "deployment",
            "runtime",
        ...
        failure_semantics=("deployment_runtime_or_explicit_operation_unavailable"),
    ),
    ConnectorSpec(
