...
# The knob-overlay shadow (compares two picker knob configs against the SAME
# artifact, rather than two artifacts) lives in shadow_knobs.py. Re-imported
# here because tests and job2.py reference it via ``shadow._name``.
from wnba_oracle.scheduler.shadow_knobs import (  # noqa: E402
    _KNOB_DEFAULTS,
    _KNOB_SHADOW_PREFIX,
    _apply_knob_overlay,
