...
class TestConfidence:
    ...
    def test_regressive_streak_lowers_confidence(self) -> None:
        ...
        no_streak = classify_archetype(
            _make_input(
                fantasy_pts_l5=20.0,
                fantasy_pts_l10=20.0,
            )
        )
        regressive_streak = classify_archetype(
            _make_input(
                fantasy_pts_l5=30.0,
                fantasy_pts_l10=20.0,
                pts_per_min_l5=0.6,
...
class TestClassifyPool:
    ...
    def test_all_archetypes_representable(self) -> None:
        ...
        pool = [
            _make_input(player_id=1, mins_l10=32.0, usg_pct_l10=0.28, implied_team_total=46.0),
            _make_input(
                player_id=2,
                is_confirmed_starter=False,
                is_anchor=False,
            ...
            _make_input(
                ...
                is_anchor=False,
                mins_l10=8.0,
                pts_per_min_l10=0.12,
                ast_per_min_l10=0.03,
                stl_blk_per_min_l10=0.01,
                usg_pct_l10=0.08,
                implied_team_total=36.0,
                vegas_total=145.0,
            ),
        ]
        result = classify_pool(pool)
