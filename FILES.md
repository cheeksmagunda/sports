...
Generated from `git ls-files`. 901 tracked files. Regenerate with `scripts/generate_file_manifest.py`.
...
- nfl-oracle/tests/unit/test_replay_contest_pool.py -- Unit tests for nfl_oracle.replay.contest_pool_replay (#280).
...
- nfl-oracle/tests/unit/test_replay_racer.py -- Offline unit tests for nfl_oracle.replay.racer (#339).
...
- wnba-oracle/src/wnba_oracle/picker/shark_signal.py -- Prior-only shark draft-rate signal.
...
- wnba-oracle/tests/unit/test_shark_signal.py -- Offline unit tests for ``wnba_oracle.picker.shark_signal``.
