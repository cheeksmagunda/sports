...
from nfl_oracle.calendar.schedule import SCHEDULE_TIMEZONE
...
def eastern_today(*, now: datetime | None = None) -> date:
    ...
    return clock.astimezone(SCHEDULE_TIMEZONE).date()
