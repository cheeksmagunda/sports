...
`NFL_PICKER_POSITION_CALIBRATION`, `NFL_PICKER_PROFILE`. Shared-fit sweep via
`make picker-knob-sweep` / `scripts/sweep_picker_knobs.py` on the same 91
Corpus C contests with field evidence as the #318 baseline (same context
snapshot, weekly retrain, leakage guard). No LightGBM.

| profile | n | mean | median | zero-boost mean (n=4) | boosted mean (n=87) | delta vs identity |
|---------|---|------|--------|------------------------|---------------------|-------------------|
| identity (production) | 91 | 51.7% | 50.5% | 74.9% | 50.7% | 0 |
| boost_0.25 | 91 | 57.7% | 56.9% | 74.1% | 56.9% | +5.9 |
| boost_0.50 | 91 | 57.8% | 58.8% | 66.0% | 57.4% | +6.0 |
| boost_0.75 | 91 | **57.9%** | 59.1% | 49.9% | **58.3%** | **+6.2** |
| pos_1.0 | 91 | 50.0% | 49.5% | 71.3% | 49.0% | -1.8 |
| boost_0.35_pos_0.5 | 91 | 57.6% | 56.2% | 70.8% | 57.0% | +5.8 |

- Best overall and best on the boosted majority: `boost_0.75`. Position
  calibration alone hurts; combined with boost it does not beat boost-only.
- Zero-boost caveat: higher boost blends trade zero-boost capture for boosted
  gains. `boost_0.25` nearly preserves zero-boost (74.1% vs 74.9%) while still
  taking most of the all-contest lift.
- Production Railway flip (pre-authorized 3ec2bad / #37): set
  `NFL_PICKER_BOOST_RANK_BLEND=0.75`, `NFL_PICKER_PROFILE=boost_0.75` on
