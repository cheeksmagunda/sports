...
def test_tracked_seasons_upper_bound_follows_calendar() -> None:
    assert tracked_seasons(datetime(2026, 9, 26, tzinfo=ZoneInfo("America/New_York")))[-1] == 2026
    assert tracked_seasons(datetime(2026, 2, 1, tzinfo=ZoneInfo("America/New_York")))[-1] == 2025
    assert tracked_seasons(datetime(2026, 9, 26, tzinfo=ZoneInfo("America/New_York")))[0] == 2002
